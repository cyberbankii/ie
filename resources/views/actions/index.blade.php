...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="/actions"><i class="fa fa-tasks"></i> Actions</a></li>
	...
	<div class="row">
		<div class="col-xs-12 col-md-12">
		    <div class="right-button" style="float: right;margin-bottom: 8px">
		    	<a href="/actions/create" class="btn btn-primary"><b>Add New</b></a>
		    </div>
	    </div>
	</div>
	<div class="row">
		              ...
		              <table id="campaign-projects" class="table table-bordered table-striped">
		                ...
		                <tbody>
			                ...
			                <tr>
			                  ...
			                  <td><center>{{ $action->updated_at }}</center></td>
			                  <td>
			                  	<center>
				                  <a href="/actions/{{ $action->id }}/edit" class="btn btn-warning"><i class="fa fa-edit"></i></a>
				                  <a href="#" class="btn btn-danger" data-toggle="modal" data-target="#deleteModal" data-id="{{ $action->id }}">
...
<script type="text/javascript">
    ...
    $('#deleteModal').on('show.bs.modal', function(e) {
        ...
        let modal = $(this);
        modal.find("#deleteForm").attr('action', '/actions/'+id);
    });
</script>
@endsection